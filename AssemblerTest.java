...
public class AssemblerTest {
    ...
    private static void assertArrayEquals(Instruction[] expectedP1, Object[] toArray) {
        ...
        public void test2() {
            ...
            input2.add(new Instruction(100,0,16,8,0,0,0,0,1)); // bge step not covered in regular slew of tests
            
            Instruction[] phase1_expected2 = {
                    new Instruction(8, 1,16,8,0,0,0,0,0),
                    new Instruction(5, 0,1,0,0,0,0,0,1)
                };
            
            Instruction[] phase2_expected2 = { 
                    new Instruction(8,1,16,8,0,0,0,0,0),
                    new Instruction(5,0,1,0,0xfffffffc,0,0,0,1),
                };
            
            Integer[] phase3_expected2 = {
                    34080810, 
                    337641472, 
                    337641472
                };
